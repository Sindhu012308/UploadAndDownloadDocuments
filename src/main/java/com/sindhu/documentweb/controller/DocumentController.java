package com.sindhu.documentweb.controller;
...
import com.sindhu.documentweb.repos.DocumentRepository;
...
public class DocumentController {
	...
	public String displayUpload(ModelMap modelMap) {
		documentsList(modelMap);
		return "documentUpload";
	}

	private void documentsList(ModelMap modelMap) {
